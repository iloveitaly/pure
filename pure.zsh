...
prompt_pure_setup() {
	...
	local non_breaking_space=$'\U00A0'
	local prompt_indicator='%(?.%F{$prompt_pure_colors[prompt:success]}.%F{$prompt_pure_colors[prompt:error]})${prompt_pure_state[prompt]}%f'$non_breaking_space
